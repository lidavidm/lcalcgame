...
var Level = function () {
    ...
    _createClass(Level, [{
        ...
        value: function build(canvas) {
            ...
            // UI Buttons
            var ui_padding = 10;
            var btn_back = new mag.Button(canvas_screen.width - 64 * 3 - ui_padding, ui_padding, 64, 64, { default: 'btn-back-default', hover: 'btn-back-hover', down: 'btn-back-down' }, function () {
