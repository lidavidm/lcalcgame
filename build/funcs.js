...
var FuncExpr = function (_Expression) {
    ...
    function FuncExpr() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(FuncExpr).apply(this, arguments));
    }
    ...
    _createClass(FuncExpr, [{
        ...
        value: function update() {
            _get(Object.getPrototypeOf(FuncExpr.prototype), 'update', this).call(this);
        ...
        value: function draw(offset) {
            _get(Object.getPrototypeOf(FuncExpr.prototype), 'draw', this).call(this, offset);
            ...
            if (reduced_expr && reduced_expr != this) {
                ...
                var _ret = function () {
                    ...
                    superReduce = function superReduce() {
                        _this4.bag = bagCopy;
                        _this4.update();
                        _this4.bag = _get(Object.getPrototypeOf(MapFunc.prototype), 'performReduction', _this4).call(_this4);
                        stage.draw();
                    };
...
var SimpleMapFunc = function (_MapFunc) {
    ...
    function SimpleMapFunc(oneParamFunc, bag) {
        ...
        var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(SimpleMapFunc).call(this, oneParamFunc, bag));
...
var ReduceFunc = function (_FuncExpr2) {
    ...
    function ReduceFunc(twoParamFunc, iterable, initializer) {
        ...
        var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(ReduceFunc).call(this, [iterable, initializer, twoParamFunc]));
    ...
    _createClass(ReduceFunc, [{
        ...
        key: 'size',
        get: function get() {
            var sz = _get(Object.getPrototypeOf(ReduceFunc.prototype), 'size', this);
