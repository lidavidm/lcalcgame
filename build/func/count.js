...
var CountExpr = function (_Expression) {
    _inherits(CountExpr, _Expression);
    ...
    function CountExpr(collectionExpr) {
        ...
        var _this = _possibleConstructorReturn(this, (CountExpr.__proto__ || Object.getPrototypeOf(CountExpr)).call(this, [txt, collectionExpr]));

        _this.color = 'DarkTurquoise';
        txt.color = 'white';
        return _this;
    }
